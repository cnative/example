...
func _000001_initDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_init.down.sql", size: 19, mode: os.FileMode(420), modTime: time.Unix(1569090457, 0)}
...
func _000001_initUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_init.up.sql", size: 177, mode: os.FileMode(420), modTime: time.Unix(1569090457, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
